...
declare -A brewPackages=(["git"]="git" ["cmake"]="cmake" ["unrar"]="unrar" ["glfw3"]="homebrew/versions/glfw3" ["glew"]="glew" ["glm"]="glm" ["libpng"]="libpng" ["brew-cask"]="caskroom/cask/brew-cask" ["node"]="node" ["phantomjs"]="phantomjs" ["casperjs"]="casperjs" ["wget"]="wget" ["bash"]="bash" ["tmux"]="tmux" ["sdl2"]="sdl2" ["unrar"]="unrar" ["valgrind"]="valgrind")
